...
var DOMAIN = "nlan.yeehee.cn";//配置域名,域名只修改此处。
var MINAPPTYPE="1";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="纳兰央措"; //网站名称
...
var INDEXNAV = [
  { id: '1', name: '巧玩手账', image: '../../images/learn_line.svg', url: '../list/list?categoryID=5', redirecttype: 'apppage', appid: '', extraData:'' },
  { id: '2', name: '写作学堂', image: '../../images/policy_fill.svg', url: '../list/list?categoryID=4', redirecttype: 'apppage', appid: '', extraData:''},   
  { id: '3', name: '热门排行', image: '../../images/medal_fill.svg', url: '../hot/hot', redirecttype: 'apppage', appid: '', extraData: '' },
   ]
